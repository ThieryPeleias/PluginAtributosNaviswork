    ...
    public static class DatasmithExporterService
    {
            ...
            double originZ = 0)
        {
            ...
            try
            {
                ...
                var pluginRecord = Autodesk.Navisworks.Api.Application.Plugins.FindPlugin("Datasmith.EpicGames");
                if (pluginRecord == null)
                {
                    Log("[ERROR] Epic Games Datasmith Exporter Plugin (Datasmith.EpicGames) not found in Navisworks!");
                    return false;
                }
